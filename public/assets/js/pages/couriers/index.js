dtTable = $("#couriers_table").DataTable({
    responsive: true,
    searchDelay: 500,
    processing: true,
    serverSide: true,
            ...
            render: function (data, type, full, meta) {
                return (
                    `
                        ...
                        <a href="couriers/` +
                    full.id +
                    `/edit" class="kt-nav__link" title="Edit Courier">							
                    ...
                    `','couriers/` +
                    full.id +
                    `')" class="kt-nav__link" title="Remove Courier">							
                            <i class="kt-nav__link-icon  flaticon2-rubbish-bin"></i>										
                            <span class="kt-nav__link-text">Remove</span>								
                        </a>										
                        </li>									
                        <li class="kt-nav__item">											
                        <a href="courier-drivers/` +
                    full.id +
                    `" class="kt-nav__link" title="View and Edit Courier Drivers">							
                            <i class="kt-nav__link-icon flaticon2-delivery-truck"></i>											
                            <span class="kt-nav__link-text">Drivers</span>									
                        </a>										
                        </li>										
                        </ul>								
                        </div>							
