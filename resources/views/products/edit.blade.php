...
@section('content')
	<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
		...
		<div class="kt-subheader  kt-grid__item" id="kt_subheader">
			<div class="kt-container  kt-container--fluid ">
				<div class="kt-subheader__main">
					<h3 class="kt-subheader__title">{{ $product->title }}</h3>
					<span class="kt-subheader__separator kt-subheader__separator--v"></span>
					<span class="kt-subheader__desc">update product details</span>
				</div>
                <div class="kt-subheader__toolbar">
                    <div class="kt-subheader__wrapper">
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-brand btn-bold update-product-btn" data-url="{{url('products')}}/{{$product->id}}" id="update-product-btn">
                                Update 
                            </button>
                        </div>
                    </div>
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="kt-wizard-v4" id="update_product_user_wizard" data-ktwizard-state="step-first">
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-grid">
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                ...
                                <form class="kt-form" id="kt_product_update_form">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input data-category="{{ $product->product_category_id }}" id="product_id" value="{{ $product->id }}" type="hidden" class="form-control" name="id" >
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div id="category_field" data-url="{{ url('product-categories/fetch-product-categories') }}" class="form-group">
                                                                        ...
                                                                        <select id="category" name="category" class="form-control select2">
                                                                            <option value="{{ $product->product_category_id }}">{{ $category->title }}</option>
                                                                        </select>
                                                                        
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div id="supplier_field" data-url="{{ url('suppliers/fetch-suppliers') }}" class="form-group">
                                                                        <label>Supplier *</label>
                                                                        <select id="supplier" name="supplier" class="form-control select2">
                                                                            <option value="{{ $product->supplier_id }}">{{ $supplier->fname }}</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <div class="modal-body">
                    <form class="kt-form" id="kt_product_category_add_form">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <button type="button" class="btn btn-brand update-product-category-btn float-right m-2" data-url="{{url('product-categories')}}" id="update-product-category-btn">
                                    Submit 
                                </button>
